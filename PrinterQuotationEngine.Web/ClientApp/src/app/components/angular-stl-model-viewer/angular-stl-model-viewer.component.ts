// From: https://github.com/codaline-io/angular-stl-model-viewer/blob/master/projects/angular-stl-model-viewer/src/lib/angular-stl-model-viewer.component.ts
// Added directly due to issues with trying to call it via code
