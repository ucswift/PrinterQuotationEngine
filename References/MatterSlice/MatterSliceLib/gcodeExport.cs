...
namespace MatterHackers.MatterSlice
{
	public class GCodeExport
	{
		...
		public PrintData Finalize(long maxObjectHeight, int moveSpeed, string endCode)
		{
			...
			data.FilamentUsedExtruder1 = GetTotalFilamentUsed(0);
			data.FilamentUsedExtruder2 = GetTotalFilamentUsed(1);
			data.TotalPrintTime = GetTotalPrintTime();
